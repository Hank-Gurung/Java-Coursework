...
public class DebitDisplay extends JFrame{
    public DebitDisplay(ArrayList<BankCard> bankCards){
        ...
        String[] columnNames = {"Card Id", "Bank Account", "Balance", "Client Name", "Issuer Bank", "Pin", "Has Withdrawn"};
        ...
        for (int i = 0; i < debitCards.size(); i++) {
            ...
            data[i][4] = String.valueOf(debitCards.get(i).getIssuerBank());
